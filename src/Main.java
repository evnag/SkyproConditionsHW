public class Main {
    public static void main(String[] args) {
        ...
        **Важно**: вложенность больше двух этажей не допускается (условный оператор внутри условного оператора).
        ...
        } else System.out.println("Приложение будет работать корректно");
        ...
        switch (monthNumber) {
            case 1:
                System.out.println(monthNumber + " - Январь пренадлежит сезону зима");
                break;
            case 2:
                System.out.println(monthNumber + " - Февраль пренадлежит сезону зима");
                break;
            case 3:
                System.out.println(monthNumber + " - Март пренадлежит сезону весна");
                break;
            case 4:
                System.out.println(monthNumber + " - Апрель пренадлежит сезону весна");
                break;
            case 5:
                System.out.println(monthNumber + " - Май пренадлежит сезону весна");
                break;
            case 6:
                System.out.println(monthNumber + " - Июнь пренадлежит сезону лето");
                break;
            case 7:
                System.out.println(monthNumber + " - Июль пренадлежит сезону лето");
                break;
            case 8:
                System.out.println(monthNumber + " - Август пренадлежит сезону лето");
                break;
            case 9:
                System.out.println(monthNumber + " - Сентябрь пренадлежит сезону осень");
                break;
            case 10:
                System.out.println(monthNumber + " - Октябрь пренадлежит сезону осень");
                break;
            case 11:
                System.out.println(monthNumber + " - Ноябрь пренадлежит сезону осень");
                break;
            case 12:
                System.out.println(monthNumber + " - Декабрь пренадлежит сезону зима");
                break;
            default:
                System.out.println(monthNumber + " - номер месяца больше 12");
        }
    }
}